      ...
      <div className="max-w-[1100px] mx-auto flex justify-between items-center">
        ...
        <ul className="hidden md:flex space-x-6 text-white">
          ...
          <li className="-ml-2">
            <Link 
              href="/login" 
              className="px-4 py-2 border border-white/30 text-white rounded-full hover:bg-white/10 hover:text-[#fecb33] transition-colors"
            >
              Sign in
            </Link>
          </li>
              ...
              <ul className="space-y-4 text-white font-thin">
                ...
                <li>
                  <Link 
                    ...
                    className="inline-block px-4 py-2 border border-white/30 text-white rounded-full hover:bg-white/10 transition-colors"
                  >
                    Sign in
                  </Link>
                </li>
